...
const routes = [
  ...
  { path: '/artworkList', name: 'ArtworkList', component: () => import('../views/Artwork/ArtworkList.vue') },
  { path: '/recentArtwork', name: 'RecentArtwork', component: () => import('../views/Artwork/RecentArtWork.vue') },
  { path: '/artworks/:id', name: 'ArtworkDetail', component: () => import('../views/Artwork/ArtworkDetail.vue') },
  ...
  { path: '/FAQs', name: 'FAQs', component: () => import('../views/User/FAQs.vue') },
  ...
  { path: '/userLogin', name: 'UserLogin', component: () => import('../views/User/UserLogin.vue'), meta: { guestOnly: true }, alias: '/userlogin' },
  { path: '/register', name: 'RegisterUser', component: () => import('../views/User/RegisterUser.vue'), meta: { guestOnly: true } },
  ...
  { path: '/wishlist', name: 'WishList', component: () => import('../views/shopping/WishList.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/notifications', name: 'Notifications', component: () => import('../views/User/NotificationList.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/customerDashboard', name: 'CustomerDashboard', component: () => import('../views/User/CustomerDashBoard.vue'), meta: { requiresAuth: true, roles: [ROLES.CUSTOMER] } },
  { path: '/artistDashboard', name: 'ArtistDashboard', component: () => import('../views/User/ArtistDashboard.vue'), meta: { requiresAuth: true, roles: [ROLES.ARTIST] } },
  { path: '/managerDashboard', name: 'ManagerDashboard', component: () => import('../views/Manager/ManagerDashboard.vue'), meta: { requiresAuth: true, roles: [ROLES.MANAGER] } },
  { path: '/adminDashboard', name: 'AdminDashboard', component: () => import('../views/Admin/AdminDashboard.vue'), meta: { requiresAuth: true, roles: [ROLES.ADMIN] } },
  { path: '/organizationDashboard', name: 'OrganizationDashboard', component: () => import('../views/Organization/OrganizationPanel.vue'), meta: { requiresAuth: true, roles: [ROLES.ORGANIZATION] } },
  ...
  { path: '/registerCompetitor', name: 'RegisterCompetitor', component: () => import('../views/User/RegisterCompetitor.vue'), meta: { requiresAuth: true, roles: [ROLES.ARTIST] } },
  ...
  { path: '/eventDisplay', name: 'EventDisplay', component: () => import('../views/Organization/EventDisplay.vue') },
  { path: '/registerOrganization', name: 'RegisterOrganization', component: () => import('../views/Organization/RegisterOrganization.vue'), meta: { requiresAuth: true, roles: [ROLES.ADMIN] } },
  { path: '/displayStandard', name: 'UserStandard', component: () => import('../views/User/UserStandard.vue') },
