  ...
  <div class="group relative bg-white rounded-xl shadow-md overflow-hidden transition-all hover:shadow-xl">
    ...
    <div class="p-4">
      <div class="flex items-start justify-between mb-2">
        <h3 class="text-lg font-semibold text-gray-900 line-clamp-1">{{ displayTitle }}</h3>
...
const displayTitle = computed(() => props.artwork.title || props.artwork.artworkName);
const displayPrice = computed(() => typeof props.artwork.price === 'number' ? props.artwork.price : parsePrice(props.artwork.price));
