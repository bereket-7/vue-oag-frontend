<template>
  <div class="bg-white rounded-xl shadow-md p-6">
    ...
    <ReviewForm v-if="authStore.isAuthenticated" :artwork-id="artworkId" @submitted="loadReviews" />
    <div class="space-y-4 mt-4">
      ...
      <EmptyState v-if="!reviews.length" title="No reviews yet" message="Be the first to review this artwork." icon="fas fa-star" />
    </div>
  </div>
</template>
