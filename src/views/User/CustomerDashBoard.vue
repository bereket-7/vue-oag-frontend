<template>
  <div class="container-fluid rounded bg-white">
    <div class="justify-content-between align-items-center border-bottom border-top dashboard">
      <h2 class="text-start font-weight-bold">
        MY ACCOUNT
      </h2>
      <h6 class="text-start">
        DASHBOARD
        ...
        <div class="sidebar">
          <ul class="navbar-list">
            <li class="nav-item">
              <router-link
                to="/"
                class="nav-link border-bottom text-start sideNavList"
              >
                HOME
              </router-link>
            </li>
            ...
            <div class="row mt-2">
              <div class="col-md-4">
                <router-link to="/">
                  <button
                    type="button"
                    class="btn btn-outline-secondary w-100 h-1 m-1 text"
                    style="height:70px;"
                  >
                    Home
                  </button>
            ...
            <div class="row mt-2">
              ...
              <div class="col-md-4">
                <router-link to="/edit-account">
                  <button
                    type="button"
                    class="btn btn-outline-secondary w-100 h-10 m-1 text"
                    style="height:70px;"
                  >
                    Account Details
                  </button>
