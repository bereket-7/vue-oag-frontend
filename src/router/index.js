...
const routes = [
  ...
  { path: '/userLogin', name: 'UserLogin', component: () => import('../views/User/UserLogin.MODERN.vue'), meta: { guestOnly: true } },
  ...
  { path: '/registerOrganization', name: 'RegisterOrganization', component: () => import('../views/Organization/RegisterOrganization.vue'), meta: { requiresAuth: true } },
